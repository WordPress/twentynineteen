			...
			'front' => array(
				...
				'post_content' => join(
					...
					array(
						...
						'<ul class="wp-block-gallery alignwide columns-3 is-cropped"><li class="blocks-gallery-item"><figure><img src="' . get_theme_file_uri( '/img/placeholder-image-portrait.png' ) . '" alt="placeholder" data-id="97" data-link="http://twentynineteen.local/two-cows-in-a-bath-tub/image/" class="wp-image-97"/><figcaption>' . _x( 'Ava Young, Founder', 'Theme starter content', 'twentynineteen' )  . '</figcaption></figure></li><li class="blocks-gallery-item"><figure><img src="' . get_theme_file_uri( '/img/placeholder-image-portrait.png' ) . '" alt="placeholder" data-id="44" data-link="http://twentynineteen.local/photo/" class="wp-image-44"/><figcaption>' . _x( 'Doug Watson, Creative Director', 'Theme starter content', 'twentynineteen' ) . '</figcaption></figure></li><li class="blocks-gallery-item"><figure><img src="' . get_theme_file_uri( '/img/placeholder-image-portrait.png' ) . '" alt="placeholder" data-id="631" data-link="http://twentynineteen.local/logo/" class="wp-image-631"/><figcaption>' . _x( 'Taco, Good Dog',  'Theme starter content', 'twentynineteen' ) . '</figcaption></figure></li></ul>',
						'<!-- /wp:gallery -->',
